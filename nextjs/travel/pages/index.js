  ...
  return (
    <>
      ...
      <div>
        ...
        <AmpState id="ui_reset">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="ui_filterPane">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="ui_sortPane">
          <script type="application/json">{false}</script>
        </AmpState>

        <AmpState id="fields_query">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_query_initial">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_query_live">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_query_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_query">
          <script type="application/json">{''}</script>
        </AmpState>

        <AmpState id="fields_departure">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_departure_initial">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_departure_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_departure">
          <script type="application/json">{''}</script>
        </AmpState>

        <AmpState id="fields_return">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_return_initial">
          <script type="application/json">{''}</script>
        </AmpState>
        <AmpState id="fields_return_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_return">
          <script type="application/json">{''}</script>
        </AmpState>

        <AmpState id="fields_type">
          <script type="application/json">{[]}</script>
        </AmpState>
        <AmpState id="fields_type_initial">
          <script type="application/json">{[]}</script>
        </AmpState>
        <AmpState id="fields_type_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_type">
          <script type="application/json">{[]}</script>
        </AmpState>

        <AmpState id="fields_city">
          <script type="application/json">{[]}</script>
        </AmpState>
        <AmpState id="fields_city_initial">
          <script type="application/json">{[]}</script>
        </AmpState>
        <AmpState id="fields_city_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_city">
          <script type="application/json">{[]}</script>
        </AmpState>

        <AmpState id="fields_sort">
          <script type="application/json">{'popularity-desc'}</script>
        </AmpState>
        <AmpState id="fields_sort_initial">
          <script type="application/json">{'popularity-desc'}</script>
        </AmpState>
        <AmpState id="fields_sort_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_sort">
          <script type="application/json">{'popularity-desc'}</script>
        </AmpState>

        <AmpState id="fields_maxPrice">
          <script type="application/json">{801}</script>
        </AmpState>
        <AmpState id="fields_maxPrice_initial">
          <script type="application/json">{801}</script>
        </AmpState>
        <AmpState id="fields_maxPrice_live">
          <script type="application/json">{801}</script>
        </AmpState>
        <AmpState id="fields_maxPrice_edited">
          <script type="application/json">{false}</script>
        </AmpState>
        <AmpState id="query_maxPrice">
          <script type="application/json">{801}</script>
        </AmpState>
      </div>
          ...
          <div className="travel-footer-wrapper">
            ...
            <section className="travel-popular pb4 pt3 relative">
              <header className="max-width-3 mx-auto px1 md-px2">
                <h3
                  className="h1 bold line-height-2 md-hide lg-hide"
                  aria-hidden="true">
                  Top Adventures
                  <br />
                  Near You
                    ...
                    <div className="m1 mt3 mb2">
                      <div className="travel-popular-tilt-right mb1">
                        <div className="relative travel-results-result">
                          <a
                            className="travel-results-result-link block relative"
                            href="#">
                            <amp-img
                ...
                <div className="travel-featured-grid flex flex-wrap items-stretch">
                  ...
                  <div className="col-12 md-col-6 flex items-stretch flex-auto">
                    ...
                    <a
                      ...
                      />
                      <div className="travel-featured-overlay absolute z1 center top-0 right-0 bottom-0 left-0 white p2">
                        <div className="travel-featured-tile-heading caps bold h3">
                          Reykjavik
                        </div>
              ...
              <div className="relative bg-black">
                ...
                <div className="max-width-3 mx-auto px1 md-px2">
                  <div className="flex pt3 md-pt4 col-12 md-col-6 pr3">
                    ...
                    <div className="col-5">
                      <h4 className="travel-spacing-none mb2 h3 gray bold">
                        Company
                      </h4>
