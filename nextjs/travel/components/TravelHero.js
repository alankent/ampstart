    ...
    <>
      <style jsx global>{`
        ...
        .travel-hero-bg-img:first-child {
          ...
          background: url(/img/travel/hero-2-preview.jpg) no-repeat 50%
            50%;
        ...
        .travel-hero-bg-img:nth-child(2) {
          ...
          background: url(/img/travel/hero-3-preview.jpg) no-repeat 50%
            50%;
          background-size: cover;
        }
        ...
        .travel-hero-bg-img:nth-child(3) {
          ...
          background: url(/img/travel/hero-1-preview.jpg) no-repeat 50%
            50%;
          background-size: cover;
        }
